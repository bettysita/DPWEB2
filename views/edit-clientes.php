<<<<<<< HEAD:views/edit-clientes.php
<!-- Inicio de cuerpo de Página -->
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header">Editar Datos de Clientes</h5>
            <?php
            if (isset($_GET["views"])) {
...
<!-- Fin de cuerpo de Página -->
 <script src="<?php echo BASE_URL; ?>views/function/clientes.js"></script>
 <script>
    edit_clientes();
 </script>
=======
...
>>>>>>> bd3482433679cf4fce04f27e62d13fa276e9bdfa:view/new-user.php
