            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        ...
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="realizarVenta()">Realizar Venta</button>
                    </div>
                    <!-- Modal -->
                                    ...
                                    <form id="form_venta">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="datetime" class="form-control" id="fecha_venta" name="fecha_venta" value="<?= date('Y-m-d H:i:s'); ?>">
